...
public interface RuntimeService {
    ...
    /**
     * Suspends the execution of a specific process instance.
     * <p>
     * When a process is suspended, it remains in its current state,
     * but no further execution is performed until it is activated again.
     * Jobs, timers, and message correlations for this process instance
     * are paused.
     * </p>
     *
     ...
     * allowing jobs, timers, and message correlations to continue.
     * </p>
     *
     * @param processId the unique identifier of the process instance
     */
