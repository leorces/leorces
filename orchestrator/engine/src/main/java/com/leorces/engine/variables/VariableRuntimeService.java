...
public class VariableRuntimeService {

    private final VariableEvaluationService evaluationService;
    private final VariablesUpdateService updateService;
    ...
    public void setProcessVariables(Process process, Map<String, Object> variables) {
        updateService.setProcessVariables(process, variables);
    }

    public void setVariables(String executionId, Map<String, Object> variables) {
        updateService.setVariables(executionId, variables);
    }

    public void setVariablesLocal(String executionId, Map<String, Object> variables) {
        updateService.setVariablesLocal(executionId, variables);
    }
