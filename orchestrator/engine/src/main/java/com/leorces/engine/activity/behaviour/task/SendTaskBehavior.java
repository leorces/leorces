...
@Component
public class SendTaskBehavior extends AbstractExternalTaskBehavior {

    protected SendTaskBehavior(ActivityPersistence activityPersistence,
