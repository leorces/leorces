...
public abstract class AbstractConditionalGatewayBehavior extends AbstractActivityBehavior {

    protected final ExpressionEvaluator expressionEvaluator;

    protected AbstractConditionalGatewayBehavior(ActivityPersistence activityPersistence, ExpressionEvaluator expressionEvaluator, CommandDispatcher dispatcher) {
